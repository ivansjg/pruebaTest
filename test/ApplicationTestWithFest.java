...
// @RunWith(JUnit4.class)  
 public class ApplicationTestWithFest extends UnitTest{  
...
//		org.fest.assertions.Assertions.assertThat(webDriver.getTitle()).contains("Hello World");
		Assertions.assertThat(webDriver.getTitle()).contains("Hello World");
